...
static int
myHandle(gpointer instance, int a, int b, gpointer userdata){
   g_print("a = %d, b =%d\n",a,b);
   return a+b;
}
...
{
    klass->default_handler = myHandle;

    g_signal_new ("hello",
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST, //must LAST,because have return value
